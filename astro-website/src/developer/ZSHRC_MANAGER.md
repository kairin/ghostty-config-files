---
title: ".zshrc Manager Utility"
description: "The `.zshrc` Manager is an intelligent utility that provides **Powerlevel10k (P10k) compliant** modifications to `.zshrc` configuration files. It prevents console output warnings during shell initialization by ensuring all content is placed in the correct location relative to the P10k instant prompt block."
pubDate: 2025-11-25
